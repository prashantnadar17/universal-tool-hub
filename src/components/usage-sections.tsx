...
export function UsageSections() {
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      {recent.length > 0 && (
        <section aria-labelledby="recent-heading" className="rounded-xl border border-border bg-card/50 p-4">
      ...
      {popular.length > 0 && (
        <section aria-labelledby="popular-heading" className="rounded-xl border border-border bg-card/50 p-4">
          <div className="mb-3 flex items-center gap-2">
