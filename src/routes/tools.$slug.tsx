...
export const Route = createFileRoute("/tools/$slug")({
  ...
  head: ({ loaderData }) => {
    ...
    const description = `${tool.description} Free, fast, no signup. Part of 100+ online tools.`;
    return {
      meta: [
        { title },
...
function ToolPage() {
  ...
  return (
    <main className="min-w-0 px-3 py-6 xsm:px-4 sm:px-6 mg:py-8 lg:px-8 2xl:px-10 3xl:px-12">
